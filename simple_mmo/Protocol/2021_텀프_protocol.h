...
constexpr int move_cooldown = 200;
constexpr int attck_cooldown = 1000;

constexpr int SECTOR_X = 25;
constexpr int SECTOR_Y = 25;
...
struct cs_packet_move {
	...
	unsigned int move_time;			// Stress Test 프로그램에서 delay를 측정할 때 사용, 
						// 서버는 해당 id가 접속한 클라이언트에서 보내온 최신 값을 return 해야 한다.
};
